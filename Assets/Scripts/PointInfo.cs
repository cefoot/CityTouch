...
public class PointInfo : MonoBehaviour
{
    ...
    public void SetInfo(string Info)
    {
        ...
        // var PointMaterials = PointPrefabRender.materials;
        // if (Info == "National")
        // {
    ...
    private void SetOnGround()
    {
        ...
        var PointHP = transform.GetComponent<HPTransform>();
        var Distance = (CameraHP.UniversePosition - PointHP.UniversePosition).ToVector3().magnitude;
